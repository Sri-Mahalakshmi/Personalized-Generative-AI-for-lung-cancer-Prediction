...
# Load icons
mic_icon = ImageTk.PhotoImage(Image.open(r"C:\Users\HP\Downloads\mic icon.jpeg").resize((30, 30)))
video_icon = ImageTk.PhotoImage(Image.open(r"C:\Users\HP\Downloads\video icon.jpeg").resize((30, 30)))
image_icon = ImageTk.PhotoImage(Image.open(r"C:\Users\HP\Downloads\image icon.jpeg").resize((30, 30)))
text_icon = ImageTk.PhotoImage(Image.open(r"C:\Users\HP\Downloads\text icon.jpeg").resize((30, 30)))
